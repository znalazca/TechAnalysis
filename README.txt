This project is a technical analysis suite capable of running on
Windows CE devices (libraries and plugins). Host application is targeted for 
Windows Desktop.

It is better to open solution using SharpDevelop 3.2 with .NET Framework 3.5
installed.

Distributed under MIT licence (except icons - their source is unknown).
